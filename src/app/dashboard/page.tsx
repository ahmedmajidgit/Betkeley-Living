...
export default function DashboardPage() {
  ...
  const openUpdateModal = () => {
    setUpdateShowModal((showUpdateModal) => !showUpdateModal);
  }
    return (
    <div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="table-auto min-w-full border-collapse border border-gray-400">
                            ...
                            <tr >
                                ...
                                {/* Baad main dalta hain delete pehly live hojaye 
                                <button className="text-lg font-bold text-[#212121] dark:text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded">
                                    Delete
                                </button> */}
                                <button className="text-lg font-bold text-[#212121] dark:text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded" onClick={openUpdateModal}>
                                    Update
                                </button>
                                </td>
                            </tr>
                            <tr >
                                ...
                                <UpdateModal openUpdateModal={openUpdateModal} showUpdateModal={showUpdateModal}/>
                                </td>
                            </tr>
